...
summary: Engineering core — strict typing, Big-O discipline, dependency governance, frontend ecosystem, error envelopes, structured observability.
---
...
* **Polyglot Routing Pointer:** Stack rules for work outside Next.js/TypeScript (Swift mobile, Go/NestJS backends, C/C++ systems) live in [`polyglot.md`](./polyglot.md) — load only if the repo ever gains such a component.
