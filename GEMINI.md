...
## Agent Orchestration
This repo runs a layered, multi-platform agent system. Overview: `AGENTS.md`. Workspace
rules for Antigravity: `.agent/rules/`. Specialist charters: `.ai/agents/` (reference one by
name in the Agent Manager). Routing + token budget: `.ai/orchestration.md`. Durable
